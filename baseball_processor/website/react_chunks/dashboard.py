...
<details className="mb-3"><summary className="passport-button">Game totals and badge filters</summary>
            ...
            <DataTable
                ...
                columns={[
                    ...
                    { key: 'venue', label: 'Venue', render: (v) => <button className="block w-full text-left text-blue-600 hover:underline" onClick={(e) => { e.stopPropagation(); window.__navigateTab('venues'); }}>{v}</button> },
                    {
                        key: 'badges',
                        label: 'Badges',
...
const ALL_MLB_STADIUMS = [
    ...
    { id: 'guaranteed', name: 'Rate Field', team: 'CHW', lat: 41.8299, lng: -87.6338, years: '1991-present', current: true, aliases: ['Guaranteed Rate Field', 'Comiskey Park II', 'U.S. Cellular Field', 'New Comiskey Park'] },
    ...
    { id: 'minutemaid', name: 'Daikin Park', team: 'HOU', lat: 29.7573, lng: -95.3555, years: '2000-present', current: true, aliases: ['Minute Maid Park', 'Enron Field', 'Astros Field'] },
    ...
    { id: 'dodger', name: 'Dodger Stadium', team: 'LAD', lat: 34.0739, lng: -118.2400, years: '1962-present', current: true, aliases: ['Chavez Ravine', 'UNIQLO Field at Dodger Stadium'] },
